...
public class Type extends Keyword {
    ...
    public static Type BOOLEAN = new Type("bool", Tag.BASIC_TYPE, 1);
    public static Type BYTES =new Type("bytes",Tag.BASIC_TYPE,1);
    //public static Type COMPLEX = new Type("complex",Tag.BASIC_TYPE,1)

    public static boolean isNumeric(Type p) {
        return p == Type.CHAR || p == Type.INT || p == Type.FLOAT || p == Type.BOOLEAN || p == Type.BYTES;
    }
    ...
    public static Type maxNumericType(Type t1, Type t2) {
        ...
        if (t1 == Type.BYTES || t2 == Type.BYTES)
        {
            return Type.BYTES;
        }
        return Type.CHAR;
